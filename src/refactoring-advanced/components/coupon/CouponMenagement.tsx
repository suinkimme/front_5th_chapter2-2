      ...
      <div className="bg-white p-4 rounded shadow">
        <div className="space-y-2 mb-4">
          <input
            ...
            onChange={(e) => editNewCouponName(newCoupon, e.target.value)}
          ...
          <input
            ...
            onChange={(e) => editNewCouponCode(newCoupon, e.target.value)}
            className="w-full p-2 border rounded"
          />
          <div className="flex gap-2">
            ...
            <input
              ...
              onChange={(e) =>
                editNewCouponDiscountValue(newCoupon, parseInt(e.target.value))
              }
              className="w-full p-2 border rounded"
            />
          </div>
...
export default CouponMenagement;
